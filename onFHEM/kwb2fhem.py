...
# Heizkreis
s += 'setreading {0} HK_Status {1}\n'.format("KWB_Heizkreis",HK_Status)
s += 'setreading {0} HK_Statusursache {1}\n'.format("KWB_Heizkreis",HK_Statusursache)
s += 'setreading {0} HK_RaumTempIst {1}\n'.format("KWB_Heizkreis",HK_RaumTempIst)
s += 'setreading {0} HK_RaumTempSoll {1}\n'.format("KWB_Heizkreis",HK_RaumTempSoll)
s += 'setreading {0} HK_AussenTemp {1}\n'.format("KWB_Heizkreis",HK_AussenTemp)
s += 'setreading {0} HK_VorlaufTempIst {1}\n'.format("KWB_Heizkreis",HK_VorlaufTempIst)
s += 'setreading {0} HK_Pumpe {1}\n'.format("KWB_Heizkreis",HK_Pumpe)
s += 'setreading {0} HK_Mischer {1}\n'.format("KWB_Heizkreis",HK_Mischer)
s += 'setreading {0} HK_Program {1}\n'.format("KWB_Heizkreis",HK_Program)
s += 'setreading {0} HK_AbsenkTemp {1}\n'.format("KWB_Heizkreis",HK_AbsenkTemp)
s += 'setreading {0} HK_KomfortTemp {1}\n'.format("KWB_Heizkreis",HK_KomfortTemp)
s += 'setreading {0} HK_UrlaubsFunktion {1}\n'.format("KWB_Heizkreis",HK_UrlaubsFunktion)
s += 'setreading {0} HK_UrlaubsTemp {1}\n'.format("KWB_Heizkreis",HK_UrlaubsTemp)
s += 'setreading {0} HK_UrlaubsBeginn {1}\n'.format("KWB_Heizkreis",HK_UrlaubsBeginn)
s += 'setreading {0} HK_UrlaubsEnde {1}\n'.format("KWB_Heizkreis",HK_UrlaubsEnde)
s += 'setreading {0} HK_PartyBetrieb {1}\n'.format("KWB_Heizkreis",HK_PartyBetrieb)
s += 'setreading {0} HK_PartyDurchheizenBis {1}\n'.format("KWB_Heizkreis",HK_PartyDurchheizenBis)
s += 'setreading {0} HK_AussenTempAbschaltung {1}\n'.format("KWB_Heizkreis",HK_AussenTempAbschaltung)
s += 'setreading {0} HK_AussenTempAbschaltKomfort {1}\n'.format("KWB_Heizkreis",HK_AussenTempAbschaltKomfort)
s += 'setreading {0} HK_AussenTempAbschaltAbsenk {1}\n'.format("KWB_Heizkreis",HK_AussenTempAbschaltAbsenk)
s += 'setreading {0} HK_Raumeinfluss {1}\n'.format("KWB_Heizkreis",HK_Raumeinfluss)
s += 'setreading {0} HK_Steigung {1}\n'.format("KWB_Heizkreis",HK_Steigung)
s += 'setreading {0} HK_Offset {1}\n'.format("KWB_Heizkreis",HK_Offset)
s += 'setreading {0} HK_Ecobetrieb {1}\n'.format("KWB_Heizkreis",HK_Ecobetrieb)
